...
class SnakeEnv(gym.Env):
    ...
    def _get_observation(self):
        ...
        if self.food_positions and is_head_in_grid:
            ...
            vector_obs = np.zeros(20, dtype=np.float32)
    ...
    def set_max_apples(self, value: int) -> None:
        """
        Update the maximum number of apples in the environment.
        Will take effect the next time apples are spawned.
        """
        self.max_apples = int(value)
