...
NUM_ENVS = 8  # DQN does not work well with too many environments
CONFIG: Dict[str, Any] = {
    "learning_rate": 1e-4,
    "buffer_size": 100_000,       
...
def main() -> None:
    ...
    base_dir = "models"
    run_number = len(glob.glob(os.path.join(base_dir, "DQN-*"))) + 1
    model_name = f"DQN-{run_number}"
    ...
    checkpoint_callback = CheckpointCallback(save_freq=1_000_000, save_path=models_dir)
